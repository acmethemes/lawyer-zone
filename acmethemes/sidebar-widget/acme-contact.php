 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Lawyer_Zone_Contact' ) ) {

    class Lawyer_Zone_Contact extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                    ...
                    esc_html__('AT Contact Section', 'lawyer-zone'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Contact Section.', 'lawyer-zone' )
                    )
            );
        }
    ...
    } // Class Lawyer_Zone_Contact ends here
}